...
export class UpdateAvailabilityDto {
  @ApiProperty({
    description:
      'Disponibilidad horaria del usuario. Estructura: { monday: [{start: "08:00", end: "10:00", modalidad: "VIRTUAL", lugar: "https://meet.google.com/abc"}], tuesday: [], ... }. NOTA: El campo "lugar" es OBLIGATORIO para TUTORES (deben especificar URL o ubicación física) y OPCIONAL para ESTUDIANTES.',
    example: {
      ...
      friday: [
        {
          ...
          modalidad: 'VIRTUAL',
          lugar: 'https://meet.google.com/xyz-uvw-rst',
        },
      ],
      saturday: [],
      sunday: [],
