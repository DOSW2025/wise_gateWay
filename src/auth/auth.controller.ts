...
export class AuthController {
  ...
  @ApiOperation({
    ...
    description:
      'Redirige al usuario al flujo de autenticación OAuth de Google. Este endpoint inicia el proceso de login con Google.',
  })
  @ApiResponse({
    status: 307,
  ...
  @ApiOperation({
    ...
    description:
      'Endpoint que recibe la respuesta de Google después de la autenticación. Redirige al frontend con el token JWT y la información del usuario o un mensaje de error.',
  })
  @ApiQuery({
    name: 'token',
    required: false,
  ...
  @ApiResponse({
    status: 307,
    description:
      'Redirección al frontend con los parámetros de resultado (éxito o error)',
  })
  googleAuthCallback(
